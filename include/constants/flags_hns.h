...
#define FLAG_HIDE_WILL_ROUTE39_HNS                 (HNS_EXTENDED_CONTENT_START + 77)
#define FLAG_DEFEATED_WILL_ROUTE39_HNS             (HNS_EXTENDED_CONTENT_START + 78)
#define FLAG_HIDE_CHAMPIONS_ROOM_LANCE_HNS         (HNS_EXTENDED_CONTENT_START + 79)
#define FLAG_HIDE_CHAMPIONS_ROOM_BLUE_HNS          (HNS_EXTENDED_CONTENT_START + 80)
#define FLAG_HIDE_HALLOFFAME_BLUE_HNS              (HNS_EXTENDED_CONTENT_START + 81)
#define FLAG_ULAULA_MOVE_TUTOR_PAID                 (HNS_EXTENDED_CONTENT_START + 82) // paid the Ula'ula move tutor his 5 HEART SCALES
#define FLAG_UNUSED_EXTENDED_78                    (HNS_EXTENDED_CONTENT_START + 83)
#define FLAG_UNUSED_EXTENDED_79                   (HNS_EXTENDED_CONTENT_START + 84)
#define FLAG_UNUSED_EXTENDED_80                    (HNS_EXTENDED_CONTENT_START + 85)
#define FLAG_UNUSED_EXTENDED_81                    (HNS_EXTENDED_CONTENT_START + 86)
