...
#define TRAINER_STARTING_STATUS_NONE 0xFF

static const struct TrainerWeatherOverride sTrainerWeatherOverrides[] =
{
    { TRAINER_JASMINE_1_HNS,        B_WEATHER_RAIN,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_JASMINE_1_2_HNS,      B_WEATHER_RAIN,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_JASMINE_2_HNS,        B_WEATHER_RAIN,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_JASMINE_1_3_HNS,      B_WEATHER_RAIN,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_MISTY_HNS,            B_WEATHER_RAIN,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_BROCK_HNS,            B_WEATHER_SANDSTORM, FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_PRYCE_1_HNS,          B_WEATHER_HAIL,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_PRYCE_1_2_HNS,        B_WEATHER_HAIL,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_PRYCE_2_HNS,          B_WEATHER_HAIL,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_PRYCE_1_3_HNS,        B_WEATHER_HAIL,      FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_BLAINE_HNS,           B_WEATHER_SUN,       FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_ERIKA_HNS,            B_WEATHER_SUN,       FALSE, TRAINER_STARTING_STATUS_NONE },
    { TRAINER_FALKNER_2_HNS,        B_WEATHER_NONE,      TRUE,  TRAINER_STARTING_STATUS_NONE },
    { TRAINER_FALKNER_1_HNS,        B_WEATHER_NONE,      FALSE, STARTING_STATUS_TOXIC_SPIKES_PLAYER_L2 },
    { TRAINER_LANCE_1_HNS,          B_WEATHER_NONE,      TRUE,  TRAINER_STARTING_STATUS_NONE },
    { TRAINER_CLAIR_1_HNS,          B_WEATHER_NONE,      TRUE,  TRAINER_STARTING_STATUS_NONE },
    { TRAINER_CLAIR_2_HNS,          B_WEATHER_NONE,      TRUE,  TRAINER_STARTING_STATUS_NONE },
    { TRAINER_LTSURGE_HNS,          B_WEATHER_NONE,      FALSE, STARTING_STATUS_ELECTRIC_TERRAIN },
    { TRAINER_SABRINA_HNS,          B_WEATHER_NONE,      FALSE, STARTING_STATUS_PSYCHIC_TERRAIN },
    { TRAINER_JANINE_HNS,           B_WEATHER_NONE,      FALSE, STARTING_STATUS_TOXIC_SPIKES_PLAYER_L2 },
    { TRAINER_WILL_1_HNS,           B_WEATHER_NONE,      FALSE, STARTING_STATUS_PSYCHIC_TERRAIN },
    { TRAINER_WILL_2_HNS,           B_WEATHER_NONE,      FALSE, STARTING_STATUS_PSYCHIC_TERRAIN },
    { TRAINER_KOGA_1_HNS,           B_WEATHER_NONE,      FALSE, STARTING_STATUS_TOXIC_SPIKES_PLAYER_L2 },
    { TRAINER_KOGA_2_HNS,           B_WEATHER_NONE,      FALSE, STARTING_STATUS_TOXIC_SPIKES_PLAYER_L2 },
    { 0xFFFF,                       B_WEATHER_NONE,      FALSE, TRAINER_STARTING_STATUS_NONE },
};
...
static bool32 TryApplyTrainerSpecificStartingWeather(void)
{
    ...
    for (const struct TrainerWeatherOverride *entry = sTrainerWeatherOverrides; entry->trainerId != 0xFFFF; ++entry)
    {
        if (entry->trainerId == TRAINER_BATTLE_PARAM.opponentA)
        {
            ...
            if (entry->startingStatus != TRAINER_STARTING_STATUS_NONE)
            {
                SetStartingStatus(entry->startingStatus);
                return TryFieldEffects(FIELD_EFFECT_TRAINER_STATUSES);
            }
