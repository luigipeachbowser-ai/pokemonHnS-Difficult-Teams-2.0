...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_TRIAGE, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_EARTH_EATER, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_HUGE_POWER, ABILITY_EARLY_BIRD, ABILITY_RATTLED },
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HUGE_POWER, ABILITY_EARLY_BIRD, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_RED,
